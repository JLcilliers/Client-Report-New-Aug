...
export default function ConnectionsClient({ initialConnection }: ConnectionsClientProps) {
  const [googleConnection, setGoogleConnection] = useState<GoogleConnection | null>(initialConnection)
  ...
  const disconnectGoogle = async () => {
    try {
      const response = await fetch('/api/admin/disconnect-google', {
        method: 'POST',
      })
